...
| 分頁 | 內容 |
|---|---|
| 今日 | 每日箴言、今天最重要的三件事（上限 3）、我的目標（可釘選）、習慣打卡、接下來排定的日子、人生回顧、今晚的反思。版面可以自己拖曳排序與隱藏 |
| 待辦 | 今天/本週/之後三桶、預約日期（到期自動走進今天）、本週領域平衡、生活領域篩選、搜尋（關鍵字高亮）、批次整理、週期待辦、備註 |
| 習慣 | 月曆熱度圖（可補打卡、可標休息）、近 7 天、週進度、連續天數、12 週趨勢 |
| 反思 | 心情 1–5、書寫提示、寫完按「儲存」就收起來、近 30 天心情、過去的紀錄（含今天）、依心情搜尋 |
