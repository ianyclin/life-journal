...
| 分頁 | 內容 |
|---|---|
| 今日 | 每日箴言、今天最重要的三件事(上限 3)、其他待辦、接下來排定的日子、習慣打卡、本週領域平衡、人生回顧。版面可以自己拖曳排序與隱藏 |
| 待辦 | 今天/本週/之後三桶、生活領域篩選、搜尋(關鍵字高亮)、批次整理、週期待辦、備註 |
| 習慣 | 月曆熱度圖(可補打卡、可標休息)、近 7 天、週進度、連續天數、12 週趨勢 |
| 反思 | 心情 1–5、書寫提示、自動儲存、近 30 天心情、往年的今天、依心情搜尋 |
| 目標 | 目標與「為什麼重要」、小步驟、暫停、完成後寫入不可回退的人生紀錄 |

**回顧**:人生時光軸(可依年份篩選)、年度回顧(每月完成長條、心情的一年、陪你最久的習慣、時間放在哪裡)。

**每日箴言**:五個句庫可以複選 —— 手帳原生、佛教底色、親子教養、伴侶相處,以及你自己寫的句子。
